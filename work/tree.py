...
class MyDecisionTreeQuantileRegressor(DecisionTreeRegressor):
    ...
    def __init__(self,
                 ...
                 max_leaf_nodes=None,
                 presort=False):
        super(MyDecisionTreeQuantileRegressor, self).__init__(
            criterion=criterion,
            splitter=splitter,
            max_depth=max_depth,
    ...
    def fit(self, X, y, sample_weight=None, check_input=True, X_idx_sorted=None):
        ...
        super(MyDecisionTreeQuantileRegressor, self).fit(
